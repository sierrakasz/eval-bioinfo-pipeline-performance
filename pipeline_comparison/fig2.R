...
#figure 2, panel D
d <- ordplot+ geom_point(size = 3,aes(color = sample_data(physeq)$Pipeline)) + scale_color_manual('Legend' ,values = c("#787878", "#ffb31a", "black", "#5c5c8a", "#918151")) +
...
tiff("Fig2.TIF", width = 4600, height = 4000, res=300)
